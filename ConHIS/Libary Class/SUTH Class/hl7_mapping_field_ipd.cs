...
{
    internal class hl7_mapping_field_ipd
    {
        ...
        public bool AddToMiddle(string strEVEN, string fileID)
        {
            ...
            //mshHeader = "MSH|" + encoder + "|CONHIS|THANES-DEV|Drug Dispense|BMS-HOSxP|" + DateTime.Now.ToString("yyyyMMddHHmmss") + "||ACK|" + fileID + "|P|2.3" + "\r\n";
            ...
            try
            {
                if (strEVEN == "ORM")
                {
                    ...
                    if (dsRXD.Tables[0].Rows.Count != 0)
                    {
                        ...
                        {
                            th.Prescriptionno = dsRXD.Tables[0].Rows[i]["RXD_4"].ToString();
