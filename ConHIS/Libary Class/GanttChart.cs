...
namespace ConHIS
{
    public class GanttChart : UserControl
    {
        ...
        public Font TimeFont { get; set; } = new Font("Comic Sans MS", emSize: 8, FontStyle.Regular);
        ...
        public Font RowFont { get; set; } = new Font("Comic Sans MS", 9, FontStyle.Regular);
        public Font DateFont { get; set; } = new Font("Comic Sans MS", 9, FontStyle.Bold);
        ...
        private List<Header> GetFullHeaderList()
        {
            ...
            {
                ToDate = FromDate.AddHours(34); // 24 Hours
        ...
        public void ToolTipText_Draw(Object sender, DrawToolTipEventArgs e)
        {
            ...
            using (Font font = new Font("Comic Sans MS", 12, FontStyle.Regular))
            {
