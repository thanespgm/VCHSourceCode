...
namespace ConHIS
{
    internal class Thaneshopmiddle_extentions_Vichaiyut
    {
        ...
        private string freetext3;                    //Field 06
        private string enddate;                      //Field 07
        private string endtime;                      //Field 08
        private string startdate;                    //Field 09
        private string starttime;                    //Field 10
        ...
        [StringLength(300, ErrorMessage = "FreeText3 : ขนาดข้อมูลเกิน 300 ตัวอักษร ")]
        ...
        public Thaneshopmiddle_extentions_Vichaiyut()
        {
        ...
        public DataSet GetAllExtentionsDetail(string p_runningno)
        {
            ...
            SQL += "dbo.tb_thaneshosp_middle_extention.freetext1, ";               //Field 05
            SQL += "dbo.tb_thaneshosp_middle_extention.freetext3 ";               //Field 06
            SQL += "FROM ";
        ...
        public bool InsertDataExtentionsDetail()
        {
            ...
            SQL += "@freetext1, ";                                              //Field 05
            SQL += "@freetext3 ";                                               //Field 06
            SQL += ") ";  
            using (SqlCommand cmd = new SqlCommand(SQL))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@freetext1", FreeText1));
                cmd.Parameters.Add(new SqlParameter("@freetext3", FreeText3));
