...
namespace ConHIS.Libary_Class.CRAInterface.HL7Structure
{
    public class RXD
    {
        ...
        private string rXD_30;
        private string rXD_31;
        private string rXD_32;
        private string rXD_33;
        private string rXD_34;
       ...
       // [Required(ErrorMessage = "RXD.19 - Substance Expiration Date : Thanes Required -> f_itemlotexpire")]
        ...
        [Required(ErrorMessage = "RXD.26 - Initiating Location : Thanes Required -> f_pharmacylocationcode, f_pharmacylocationdesc")]
        ...
        public string RXD_30 { get => rXD_30; set => rXD_30 = value; }
        public string RXD_31 { get => rXD_31; set => rXD_31 = value; }
        public string RXD_32 { get => rXD_32; set => rXD_32 = value; }
        public string RXD_33 { get => rXD_33; set => rXD_33 = value; }
        public string RXD_34 { get => rXD_34; set => rXD_34 = value; }
        ...
        private string InsertRXD()
        {
            ...
            SQL += "dbo.HL7_RXD.RXD_30,";
            SQL += "dbo.HL7_RXD.RXD_31,";
            SQL += "dbo.HL7_RXD.RXD_32,";
            SQL += "dbo.HL7_RXD.RXD_33,";
            SQL += "dbo.HL7_RXD.RXD_34,";
        ...
        public bool Add(RXD entity)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(InsertRXD()))
            {
                ...
                cmd.Parameters.AddWithValue("@RXD_30", entity.RXD_30);
                cmd.Parameters.AddWithValue("@RXD_31", entity.RXD_31);
                cmd.Parameters.AddWithValue("@RXD_32", entity.RXD_32);
                cmd.Parameters.AddWithValue("@RXD_33", entity.RXD_33);
                cmd.Parameters.AddWithValue("@RXD_34", entity.RXD_34);
