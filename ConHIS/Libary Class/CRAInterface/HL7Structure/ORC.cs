...
{ 
    public class ORC
    {
        ...
        private string oRC_23;
        private string oRC_24;
        private string oRC_25;
        private string oRC_26;
        private string oRC_27;
        private string oRC_28;
        private string oRC_29;
        private string oRC_30;
        private string oRC_31;
        private string oRC_32;
        private string oRC_33;
        ...
        //[Required(ErrorMessage = "ORC.15 - Order Effective Date/Time : Thanes Required -> f_ordertargetdate, f_ordertargettime")]
        ...
        public string ORC_23 { get => oRC_23; set => oRC_23 = value; }
        public string ORC_24 { get => oRC_24; set => oRC_24 = value; }
        public string ORC_25 { get => oRC_25; set => oRC_25 = value; }
        public string ORC_26 { get => oRC_26; set => oRC_26 = value; }
        public string ORC_27 { get => oRC_27; set => oRC_27 = value; }
        public string ORC_28 { get => oRC_28; set => oRC_28 = value; }
        public string ORC_29 { get => oRC_29; set => oRC_29 = value; }
        public string ORC_30 { get => oRC_30; set => oRC_30 = value; }
        public string ORC_31 { get => oRC_31; set => oRC_31 = value; }
        public string ORC_32 { get => oRC_32; set => oRC_32 = value; }
        public string ORC_33 { get => oRC_33; set => oRC_33 = value; }
        ...
        private string InsertORC()
        {
            ...
            SQL += "dbo.HL7_ORC.ORC_23,";
            SQL += "dbo.HL7_ORC.ORC_24,";
            SQL += "dbo.HL7_ORC.ORC_25,";
            SQL += "dbo.HL7_ORC.ORC_26,";
            SQL += "dbo.HL7_ORC.ORC_27,";
            SQL += "dbo.HL7_ORC.ORC_28,";
            SQL += "dbo.HL7_ORC.ORC_29,";
            SQL += "dbo.HL7_ORC.ORC_30,";
            SQL += "dbo.HL7_ORC.ORC_31,";
            SQL += "dbo.HL7_ORC.ORC_32,";
            SQL += "dbo.HL7_ORC.ORC_33,";
        ...
        public bool Add(ORC entity)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(InsertORC()))
            {
                ...
                cmd.Parameters.AddWithValue("@ORC_23", entity.ORC_23);
                cmd.Parameters.AddWithValue("@ORC_24", entity.ORC_24);
                cmd.Parameters.AddWithValue("@ORC_25", entity.ORC_25);
                cmd.Parameters.AddWithValue("@ORC_26", entity.ORC_26);
                cmd.Parameters.AddWithValue("@ORC_27", entity.ORC_27);
                cmd.Parameters.AddWithValue("@ORC_28", entity.ORC_28);
                cmd.Parameters.AddWithValue("@ORC_29", entity.ORC_29);
                cmd.Parameters.AddWithValue("@ORC_30", entity.ORC_30);
                cmd.Parameters.AddWithValue("@ORC_31", entity.ORC_31);
                cmd.Parameters.AddWithValue("@ORC_32", entity.ORC_32);
                cmd.Parameters.AddWithValue("@ORC_33", entity.ORC_33);
