...
namespace ConHIS.Libary_Class.CRAInterface.HL7Structure
{
    public class PV1
    {
        ...
        private string pV1_53;
        private string pV1_54;
        ...
        [Required(ErrorMessage = "PV1.1 - Set Id - Pv1 : Thanes Required -> เลขลำดับข้อมูล ค่าคงที่ 1")]
        public string PV1_1 { get => pV1_1; set => pV1_1 = value; }

        [Required(ErrorMessage = "PV1.2 - Patient Class : Thanes Required -> ประเภทผู้ป่วย ค่าคงที่ I = Inpatient")]
        public string PV1_2 { get => pV1_2; set => pV1_2 = value; }

        [Required(ErrorMessage = "PV1.3 - Assigned Patient Location : Thanes Required -> f_wardcode,f_warddesc,f_roomcode,f_roomdesc,f_bedcode,f_beddesc")]
        ...
        [Required(ErrorMessage = "PV1.17 - Admitting Doctor : Thanes Required -> f_doctorcode,f_doctorname ใช้ข้อมูลแพทยืเจ้าของใข้")]
        public string PV1_17 { get => pV1_17; set => pV1_17 = value; }

        [Required(ErrorMessage = "PV1.18 - Patient Type : Thanes Required -> รหัสและชื่อสิทธิ์การรักษา")]
        public string PV1_18 { get => pV1_18; set => pV1_18 = value; }

        [Required(ErrorMessage = "PV1.19 - Visit Number : Thanes Required -> f_an")]
        ...
        [Required(ErrorMessage = "PV1.40 - Bed Status : Thanes Required -> สถานะเตียง ค่าคงที่ O=Occupied")]
        ...
        public string PV1_53 { get => pV1_53; set => pV1_53 = value; }
        public string PV1_54 { get => pV1_54; set => pV1_54 = value; }
        ...
        private string InsertPV1()
        {
            ...
            SQL += "dbo.HL7_PV1.PV1_53,";
            SQL += "dbo.HL7_PV1.PV1_54,";
            SQL += "dbo.HL7_PV1.EVEN,";
            SQL += "dbo.HL7_PV1.CreatedAt) ";
            SQL += "VALUES(";
            SQL += "@SET_CODE,";
            SQL += "@PV1_1,";
            SQL += "@PV1_2,";
        ...
        public bool Add(PV1 entity)
        {
            Connection_sqlserver conn = new Connection_sqlserver(Variable.DBlocal);

            using (SqlCommand cmd = new SqlCommand(InsertPV1()))
            {
                ...
                cmd.Parameters.AddWithValue("@PV1_53", entity.PV1_53);
                cmd.Parameters.AddWithValue("@PV1_54", entity.PV1_54);
