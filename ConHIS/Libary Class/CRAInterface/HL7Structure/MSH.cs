...
namespace ConHIS.Libary_Class.CRAInterface.HL7Structure
{
    public class MSH
    {
        ...
        private string mSH_20;
        private string mSH_21;
        private string mSH_22;
        private string mSH_23;
        private string mSH_24;
        private string mSH_25;
        ...
        public string MSH_20 { get => mSH_20; set => mSH_20 = value; }
        public string MSH_21 { get => mSH_21; set => mSH_21 = value; }
        public string MSH_22 { get => mSH_22; set => mSH_22 = value; }
        public string MSH_23 { get => mSH_23; set => mSH_23 = value; }
        public string MSH_24 { get => mSH_24; set => mSH_24 = value; }
        public string MSH_25 { get => mSH_25; set => mSH_25 = value; }
        ...
        private string InsertMSH()
        {
            ...
            SQL += "dbo.HL7_MSH.MSH_20,";
            SQL += "dbo.HL7_MSH.MSH_21,";
            SQL += "dbo.HL7_MSH.MSH_22,";
            SQL += "dbo.HL7_MSH.MSH_23,";
            SQL += "dbo.HL7_MSH.MSH_24,";
            //SQL += "dbo.HL7_MSH.MSH_25,";
        ...
        public bool Add(MSH entity)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(InsertMSH()))
            {
                ...
                cmd.Parameters.AddWithValue("@MSH_20", entity.MSH_20);
                cmd.Parameters.AddWithValue("@MSH_21", entity.MSH_21);
                cmd.Parameters.AddWithValue("@MSH_22", entity.MSH_22);
                cmd.Parameters.AddWithValue("@MSH_23", entity.MSH_23);
                cmd.Parameters.AddWithValue("@MSH_24", entity.MSH_24); 
                //cmd.Parameters.AddWithValue("@MSH_25", entity.MSH_25);
