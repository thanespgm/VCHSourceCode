using ConHIS.Libary_Class.SKPHInterface.HL7Structure;
using System;
...
{
    public class SKPHGetHL7ToDBStructure
    {
        ...
        public SKPHGetHL7ToDBStructure()
        {
                    ...
                    if (ipd.Tables[0].Rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < itemsAll; i++)
                        {
                            ...
                            if (mHL7Message.SegmentArray.Count > 0)
                            {
                                        ...
                                        case "RDE":
                                            switch (ActiveFileType)
                                            {
                                                ...
                                                case "O01":
                                                    ...
                                                    {
                                                        parentData = mHL7Message.GetElement(HL7Node.MsgIndex);
                                                        childParts = parentData.Split('|'); // rxe=31
                                                        ////if (childParts.Length > 31 && childParts[0].Contains("RXE"))
                                                        //////if (freqDescData_full.Contains("(") && freqDescData_full.Contains(")"))
                                                        ////{
                                                        ////    childParts[7] = childParts[7].Replace('|', '^') + childParts[8];
                                                        ////    childParts = parentData.Split('|');
                                                        ////}
                                ...
                                //## Test
                                //#######################################################
                                //##Insert Data To tb_thanes_middle####################
                                //#######################################################

                                //#region "Data Insert Values To tb_thanes_middle"
                                MappingMiddleControllerSKPH map = new MappingMiddleControllerSKPH(EventFileType, ActiveFileType);
                        ...
                        // hl7_mapping_field_ipd map = new hl7_mapping_field_ipd();
            ...
            try
            {
                ...
                else
                {
                    RXE rXE = new RXE()
                    {
                        ...
                        RXE_5 = data[5].Trim(),
                        RXE_6 = data[6].Trim(),
                        RXE_7 = data[7].Trim().Replace("|","") + data[8].Trim(),
                        ////RXE_8 = data[8].Trim(),
                        RXE_8 = data[9].Trim(),
                        RXE_9 = data[10].Trim(),
                        RXE_10 = data[11].Trim(),
