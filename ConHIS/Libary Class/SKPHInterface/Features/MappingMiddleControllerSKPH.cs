...
{
    public class MappingMiddleControllerSKPH
    {
        private readonly thaneshopmiddle_SKPH th;
        ...
        public MappingMiddleControllerSKPH(string EventFileType,string ActiveFileType)
        {
            msh = new MSH();
            al1 = new AL1();
            nte = new NTE();
                    ...
                    foreach (DataRow rowRxr in dsRXR.Tables[0].Rows)
                    {
                        ...
                        if (dsRXE.Tables[0].Rows.Count != 0)
                        {
                            ...
                            foreach (DataRow row in dsRXE.Tables[0].Rows)
                            {
                                ...
                                th.FrequencyDesc = th.FrequencyDesc.Replace(" ละ", "ละ");
        ...
        private bool AddMasterDrugInfo(thaneshopmiddle_SKPH md)
        {
            bool result = false;
            try
            {
        ...
        private bool AddMasterInstruction(thaneshopmiddle_SKPH md)
        {
            bool result = false;
        ...
        private bool AddMasterFrequency(thaneshopmiddle_SKPH md)
        {
            bool result = false;
           frequencyinfo = new master_frequencyInfo
            {
        ...
        private bool AddMiddles(thaneshopmiddle_SKPH md)
        {
            bool result = false;
            try
            {
